...
const BannerSection = ({ category }) => {
  ...
  return (
    <div className="relative sm:h-[420px] h-[80vh] w-full flex flex-col items-center justify-center text-white text-center px-6 overflow-hidden bg-gradient-to-r from-[#01063A] via-[#1f69ff] to-[#01063A]"> 
      {/* Decorative Ribbons */}
      ...
      >
        {category.code === "Click below" ? (
          <>{category.name} Promo Code — Grab It Now!</>
        ) : category.name !== "Binance red packet" ? (
          <>
