...
const BannerSection = ({ category }) => {
  ...
  return (
    <div className="relative sm:h-[420px] h-[80vh] w-full flex flex-col items-center justify-center text-white text-center px-6 overflow-hidden bg-gradient-to-r from-[#0051ff] via-[#c8d6f4] to-[#0051ff]"> 
      {/* Decorative Ribbons */}
