...
const BannerSection = ({ category }) => {
  ...
  return (
    <div className="relative sm:h-[420px] h-[80vh] w-full flex flex-col items-center justify-center text-white text-center px-6 overflow-hidden bg-gradient-to-r from-[#01BC8D] via-[#01BC8D] to-[#01BC8D]"> 
      {/* Decorative Ribbons */}
